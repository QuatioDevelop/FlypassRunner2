...
public class PaternWindowEditor : EditorWindow
{
    ...
    static void Init()
    {
        GetWindow(typeof(PaternWindowEditor));
    }
    ...
    void OnGUI()
    {
        ...
        if (GUI.Button(new Rect(500, 580, 100, 50), "Apply"))
        {
            if (Selection.gameObjects[0].GetComponent<PatternSystem>() != null)
            {
                ...
                PrefabUtility.ReplacePrefab((Selection.gameObjects[0]), PrefabUtility.GetPrefabParent(Selection.gameObjects[0].GetComponent<PatternSystem>()));
